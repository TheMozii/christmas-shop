...
const bestGiftsSecBoxCard = document.querySelectorAll('.bestGiftsSecBoxCard');
const allButton = document.getElementById('allButton');
const workButton = document.getElementById('workButton');
const healthButton = document.getElementById('healthButton');
const harmonyButton = document.getElementById('harmonyButton');
const giftsNavigationPanel = document.querySelector('.giftsNavigationPanel');
...
const giftsCards = [
 ...
 const showGiftCards = (filterCategory = 'All') => {
   ...
   const filteredCards = filterCategory === 'All' 
      ? giftsCards 
      : giftsCards.filter(card => card.category === filterCategory);
...
giftsNavigationPanel.addEventListener('click', (e) => {
   const button = e.target.closest('.giftButtons');
   if (!button) return;
   ...
   document.querySelectorAll('.giftButtons').forEach(btn => {
      btn.style.backgroundColor = '';
   });
   button.style.backgroundColor = 'rgba(255, 255, 255, 0.2)';

   showGiftCards(category);
});
